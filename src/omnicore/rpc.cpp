        ...
        throw runtime_error(
            RPCHelpMan{"omni_getproperty",
               ...
               RPCResult{
                   ...
                   "  \"issuer\" : \"address\",            (string) the BFScoin address of the issuer on record\n"
        ...
        throw runtime_error(
            RPCHelpMan{"omni_getorderbook",
               ...
               RPCResult{
                   "[                                              (array of JSON objects)\n"
                   "  {\n"
                   "    \"address\" : \"address\",                         (string) the BFScoin address of the trader\n"
        ...
        throw runtime_error(
            RPCHelpMan{"omni_gettradehistoryforaddress",
               ...
               RPCResult{
                   ...
                   "  {\n"
                   "    \"txid\" : \"hash\",                               (string) the hex-encoded hash of the transaction of the order\n"
                   "    \"sendingaddress\" : \"address\",                  (string) the BFScoin address of the trader\n"
                   ...
                   "        \"address\" : \"address\",                         (string) the BFScoin address of the other trader\n"
        ...
        throw runtime_error(
            RPCHelpMan{"omni_gettradehistoryforpair",
               ...
               RPCResult{
                   ...
                   "    \"address\" : \"address\",                 (string) the BFScoin address of the seller\n"
                   "    \"amountsold\" : \"n.nnnnnnnn\",           (string) the number of tokens sold in this trade\n"
                   "    \"amountreceived\" : \"n.nnnnnnnn\",       (string) the number of tokens traded in exchange\n"
                   "    \"matchingtxid\" : \"hash\",               (string) the hash of the transaction that was matched against\n"
                   "    \"matchingaddress\" : \"address\"          (string) the BFScoin address of the other party of this trade\n"
                   "  },\n"
                   "  ...\n"
                   "]\n"
               },
        ...
        throw runtime_error(
            RPCHelpMan{"omni_getactivedexsells",
               ...
               RPCResult{
                   ...
                   "    \"seller\" : \"address\",               (string) the BFScoin address of the seller\n"
                   ...
                   "    \"unitprice\" : \"n.nnnnnnnn\" ,        (string) the unit price (BFS/token)\n"
                   ...
                   "      {\n"
                   "        \"buyer\" : \"address\",                (string) the BFScoin address of the buyer\n"
        ...
        throw runtime_error(
            RPCHelpMan{"omni_gettransaction",
               ...
               RPCResult{
                   ...
                   "  \"sendingaddress\" : \"address\",     (string) the BFScoin address of the sender\n"
                   "  \"referenceaddress\" : \"address\",   (string) a BFScoin address used as reference (if any)\n"
        ...
        throw runtime_error(
            RPCHelpMan{"omni_getinfo",
               ...
               RPCResult{
                   ...
                   "  \"bitcoincoreversion\" : \"x.x.x\",        (string) BFScoin Core version\n"
        ...
        throw runtime_error(
            RPCHelpMan{"omni_getsto",
               ...
               RPCResult{
                   ...
                   "  \"recipients\": [                 (array of JSON objects) a list of recipients\n"
                   "    {\n"
                   "      \"address\" : \"address\",          (string) the BFScoin address of the recipient\n"
